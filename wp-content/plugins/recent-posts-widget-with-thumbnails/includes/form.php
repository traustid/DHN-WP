<h4><?php _e( 'Display Options', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</h4>
...
<label for="<?php echo $id_open_new_window; ?>"><?php _e( 'Open post links in new windows?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_random_order; ?>"><?php _e( 'Show posts in random order?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_hide_current_post; ?>"><?php _e( 'Do not list the current post?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_keep_sticky; ?>"><?php _e( 'Keep sticky posts on top of the list?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_hide_title; ?>"><?php _e( 'Do not show post title?', 'recent-posts-widget-with-thumbnails-cdh' ); ?> <em><?php _e( 'Make sure you set a default thumbnail for posts without a thumbnail, otherwise there will be no link.', 'recent-posts-widget-with-thumbnails-cdh' ); ?></em></label></p>

<p><label for="<?php echo $id_post_title_length; ?>"><?php _e( 'Maximum length of post title', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</label>
...
<label for="<?php echo $id_show_author; ?>"><?php _e( 'Show post author?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_show_categories; ?>"><?php _e( 'Show post categories?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_show_date; ?>"><?php _e( 'Show post date?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_show_excerpt; ?>"><?php _e( 'Show excerpt?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>

<p><label for="<?php echo $id_excerpt_length; ?>"><?php _e( 'Maximum length of excerpt', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</label>
...
<p><label for="<?php echo $id_excerpt_more; ?>"><?php _e( 'Signs after excerpt', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</label>
...
<label for="<?php echo $id_show_comments_number; ?>"><?php _e( 'Show number of comments?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>

<p>
	<label for="<?php echo $id_category_ids;?>"><?php _e( 'Show posts of selected categories only?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label><br />
<?php echo $selection_element; ?><br>
	<em><?php printf( __( 'Click on the categories with pressed CTRL key to select multiple categories. If %s was selected then other selections will be ignored.', 'recent-posts-widget-with-thumbnails-cdh' ), "'" . $label_all_cats . "'" ); ?></em>
</p>

<h4><?php _e( 'Thumbnail Options', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</h4>
...
<label for="<?php echo $id_show_thumb; ?>"><?php _e( 'Display post featured image?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>

<p><label for="<?php echo $id_thumb_dimensions; ?>"><?php _e( 'Size of thumbnail', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</label>
	<select id="<?php echo $id_thumb_dimensions; ?>" name="<?php echo $this->get_field_name( 'thumb_dimensions' ); ?>">
		<option value="<?php echo $this->default_thumb_dimensions; ?>" <?php selected( $thumb_dimensions, $this->default_thumb_dimensions ); ?>><?php _e( 'Specified width and height', 'recent-posts-widget-with-thumbnails-cdh' ); ?></option>
<?php
...
?>
	...
	<em><?php printf( __( 'If you use a specified size the following sizes will be taken, otherwise they will be ignored and the selected dimension as stored in %s will be used:', 'recent-posts-widget-with-thumbnails-cdh' ), $media_trail ); ?></em>
</p>

<p><label for="<?php echo $id_thumb_width; ?>"><?php _e( 'Width of thumbnail', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</label>
...
<p><label for="<?php echo $id_thumb_height; ?>"><?php _e( 'Height of thumbnail', 'recent-posts-widget-with-thumbnails-cdh' ); ?>:</label>
...
<label for="<?php echo $id_keep_aspect_ratio; ?>"><?php _e( 'Use aspect ratios of original images?', 'recent-posts-widget-with-thumbnails-cdh' ); ?> <em><?php _e( 'If checked the given width is used to determine the height of the thumbnail automatically. This option also supports responsive web design.', 'recent-posts-widget-with-thumbnails-cdh' ); ?></em></label></p>
...
<label for="<?php echo $id_try_1st_img; ?>"><?php _e( "Try to use the post's first image if post has no featured image?", 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_only_1st_img; ?>"><?php _e( 'Use first image only, ignore featured image?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<label for="<?php echo $id_use_default; ?>"><?php _e( 'Use default thumbnail if no image could be determined?', 'recent-posts-widget-with-thumbnails-cdh' ); ?></label></p>
...
<p><?php _e( 'Do you like the plugin?', 'recent-posts-widget-with-thumbnails-cdh' ); ?> <a href="http://wordpress.org/support/view/plugin-reviews/recent-posts-widget-with-thumbnails-cdh" target="_blank"><?php _e( 'Please rate it at wordpress.org!', 'recent-posts-widget-with-thumbnails-cdh' ); ?></a></p>
<p><?php _e( 'Do you need more options?', 'recent-posts-widget-with-thumbnails-cdh' ); ?> <a href="http://shop.stehle-internet.de/downloads/ultimate-post-list-pro/" target="_blank"><?php _e( 'Get Ultimate Post List Pro!', 'recent-posts-widget-with-thumbnails-cdh' ); ?></a></p>
